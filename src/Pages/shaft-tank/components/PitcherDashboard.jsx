...
const PitcherDashboard = () => {
  ...
  const fetchInvestments = async () => {
    try {
      ...
      const pitcherResponse = await fetch(`https://ingenium-web2.onrender.com/api/pitchers/${pitcher.id}`);
      ...
      const investmentsResponse = await fetch(`https://ingenium-web2.onrender.com/api/investments/pitcher/${pitcher.id}`);
