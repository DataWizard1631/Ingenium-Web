    ...
    <div className="bg-[url('/bg-texture.jpg')] bg-repeat bg-auto py-16 px-4 sm:px-8 lg:px-12 xl:px-24 w-full flex flex-col gap-10">
      ...
      <div className="flex flex-col md:flex-row items-center justify-around px-4 sm:px-12 py-5 gap-6">
        <div className="w-full md:w-1/2 text-white text-center md:text-left">
          ...
          <p className="font-primaryFont text-4xl sm:text-5xl">INGENIUM</p>
      ...
      <div className="w-full">
        <p className="text-4xl sm:text-5xl font-primaryFont text-white text-center">MEET OUR TEAM</p>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-6 py-6 px-4 sm:px-8 lg:px-12">
      ...
      {/* Heads Section */}
      <div className="w-full">
        <p className="text-5xl sm:text-6xl md:text-7xl font-primaryFont text-center text-transparent bg-gradient-to-b from-white/50 to-gray-400 bg-clip-text">
          HEADS
        </p>
        <div className="max-w-screen-lg mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-6 py-6 px-4 sm:px-8">
          {Array(6).fill(0).map((_, i) => (
            <AboutCard key={i} name="Lorem ipsum" post="lorem" image="/1.jpg" />
          ))}
        </div>
